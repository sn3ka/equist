...
// stage content:
(lib.E_loading_white_HTML5Canvas = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:256.75,y:186.6,alpha:1},9,cjs.Ease.quintOut).wait(20).to({startPosition:0},0).to({alpha:0},10).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(7).to({_off:false},0).to({x:231.05,y:333,alpha:1},11,cjs.Ease.quintOut).wait(13).to({startPosition:0},0).to({alpha:0},8).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(16).to({_off:false},0).to({x:368.75,y:412.05,alpha:1},12,cjs.Ease.quintOut).wait(4).to({startPosition:0},0).to({alpha:0},7).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(198.7,273.5,504.59999999999997,276.5);
// library properties:
lib.properties = {
